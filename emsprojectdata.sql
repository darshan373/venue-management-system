...
-- (134, 'NMV1', 'Academic Block', 'sa', 'ds', '2022-12-20', 9, 11, 'admin', 'AI/ML', 'pending', 'pending'),
-- (135, 'NMV2', 'BasketBall Court', 'gfds', 'Quiz', '2022-12-22', 10, 12, 'admin', 'CSE', 'pending', 'pending');
...
(1, 'admin', 'admin@bmsit.in', 'bmsit123'),
(3, 'incharge', 'incharge@bmsit.in', 'bmsit123'),
(4, 'principal', 'principal@gmail.com', 'bmsit123');
...
('NMV1', 'Academic Block'),
('NMV2', 'BasketBall Court'),
('NMV3', 'VolleyBall Court'),
('NMV4', 'ISE Seminar Hall'),
('NMV5', 'CSE Seminar Hall');
